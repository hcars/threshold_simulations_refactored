		...
		for i=1:repetitions
			...
			for threshold in thresholds
				...
				for budget in budgets
						...
						blocking_summaries = [no_block_summary, timing_mcich, timing_mcich_ilp, timing_ilp_opt,  blocking_summary_mcich_smc, blocking_summary_mcich_ilp, blocking_summary_ilp_opt, blocking_summary_random, blocking_summary_degree]
						metadata = Vector{String}[name, seeding_method, string(threshold), string(num_seeds), string(curr_budget)]
