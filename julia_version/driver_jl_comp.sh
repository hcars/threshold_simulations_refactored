...
output_append="../complex_net_proposal/experiment_results/results_comp.csv"
...
do
   ...
   full+=$base
   julia main_comp.jl $full $repititions $seed_method $num_seeds $random_seed $output_append
done
