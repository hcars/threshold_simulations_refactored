...
output_append="./complex_nets_2021/experiment_results/k_core_results_epi_curves_disjoint.csv"
...
do
   ...
   full+=$base
   julia -O3 main_epi_curve_disjoint.jl $full $repititions $seed_method $num_seeds $random_seed $output_append
done
