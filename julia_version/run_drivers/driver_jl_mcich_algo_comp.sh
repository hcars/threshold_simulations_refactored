...
input_paths=("${2}")
output_append="./complex_nets_2021/experiment_results/results_mcich_smc_algo_comp_${2}_${1}.csv"
...
do
   ...
   full+=$base
   julia -O3 main_algo_comp.jl $full $repititions $seed_method $num_seeds $random_seed $output_append $blocking_method
done
