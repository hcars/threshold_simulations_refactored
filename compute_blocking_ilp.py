        ...
        for seed_size in [20]:
            ...
            for sample in range(sample_number):
                ...
                for k in range(len(thresholds)):
                    ...
                    for j in range(len(budgets)):
                        ...
                        choices_1 = cbh.try_all_sets(node_infections_1, budget_1, model, set(seed_set_1 + seed_set_3), cbh.ilp_formulation,
                                                     1)
                        if len(choices_1) < budget_1:
                            budget_2 += budget_1 - len(choices_1)
                        choices_2 = cbh.try_all_sets(node_infections_2, budget_2, model, set(seed_set_2 + seed_set_3), cbh.ilp_formulation,
                                                     2)
            ...
            for threshold in thresholds:
                for budget in budgets:
                    ...
                    with open('complex_net_proposal/experiment_results/results_ilp.csv', 'a', newline='') as results_fp:
